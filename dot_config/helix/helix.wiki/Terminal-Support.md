...
|[foot]     | ✅           | ✅              | ✅               | ✅                  | ✅                         |
|[Rio]      | ✅           | ✅              | ✅               | ✅                  | ✅ (with config)           |
|[Windows Terminal] | ✅   | ✅ [(borked)](https://github.com/crossterm-rs/crossterm/issues/737)      | ✅               | ✅ | ✅ |
| [iTerm2]  | ✅           | ✅              | ✅               | ✅                  | ✅ |
| [Warp]    | ✅           | ✅              | ✅               | ❌                  | ✅ |
...
Some terminals have this protocol disabled by default. To enable it in WezTerm, see https://wezfurlong.org/wezterm/config/key-encoding.html#kitty-keyboard-protocol. Also, to enable it in Rio, see https://rioterm.com/docs/features/kitty-keyboard-protocol.
...
## Ghostty
[Ghostty](https://github.com/ghostty-org/ghostty) was tested using version 1.0.1 on 2025-01-15.

### Known Issues

#### Key Mappings

* The default key mapping for `Alt-Left` and `Alt-Right`, conflicts with Helix (TS selection). You might want to disable it in Ghosty's preferences:
