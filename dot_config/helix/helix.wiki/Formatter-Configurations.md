...
[[language]]
name = "html"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.html"] }
auto-format = true

[[language]]
name = "css"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.css"] }
auto-format = true
```
...
[[language]]
name = "javascript"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.js"] }
auto-format = true

[[language]]
name = "typescript"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.ts"] }
auto-format = true

[[language]]
name = "jsx"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.jsx"] }
auto-format = true

[[language]]
name = "tsx"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.tsx"] }
auto-format = true
```
...
[[language]]
name = "json"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.json"] }
auto-format = true

[[language]]
name = "jsonc"
formatter = { command = 'pnpm', args = ["exec", "oxfmt", "--stdin-filepath=buffer.jsonc"] }
auto-format = true
```
