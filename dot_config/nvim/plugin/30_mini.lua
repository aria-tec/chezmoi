...
-- Use Neovim built-in default colorscheme to follow terminal emulator palette
...
now(function()
  ...
  -- -- Auto-apply transparency, cterm attributes, and terminal colors for active colorscheme
  -- local apply_customizations = function()
  --   if vim.g.applying_minicolors then return end
  --   vim.g.applying_minicolors = true
  --   local ok, cs = pcall(MiniColors.get_colorscheme)
  --   if ok and cs then
  --     cs:resolve_links()
  --       :add_transparency({
  --         general = true,
  ...
  --   end
  --
  --   -- Explicitly enforce transparent background on core highlight groups
  ...
  --   end
  --
  --   vim.g.applying_minicolors = false
  -- end
  --
  -- Config.new_autocmd('ColorScheme', '*', apply_customizations, 'Apply transparency & terminal colors')
...
later(function()
  ...
  -- Register 'registry' picker to select among all available pickers (like :Telescope builtin)
