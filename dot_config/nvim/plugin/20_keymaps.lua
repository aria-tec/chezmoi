...
-- Exit terminal mode easily with <Esc><Esc>
...
nmap_leader('fp', '<Cmd>Pick registry<CR>',                     'Pickers (all available)')
...
nmap_leader('oi', '<Cmd>lua MiniColors.interactive()<CR>', 'Interactive colors')
