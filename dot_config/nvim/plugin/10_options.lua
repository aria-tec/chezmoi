...
vim.o.confirm     = true           -- Confirm unsaved changes when closing
vim.o.mouse       = 'a'            -- Enable mouse
vim.o.mousescroll = 'ver:25,hor:6' -- Customize mouse scroll
vim.o.switchbuf   = 'usetab'       -- Use already opened buffers when switching
vim.o.timeoutlen  = 300            -- Wait time for mapped sequence (ms)
vim.o.undofile    = true           -- Enable persistent undo
vim.o.updatetime = 250            -- Faster update time for diagnostics & events

vim.o.shada = "'100,<50,s10,:1000,/100,@100,h" -- Limit ShaDa file (for startup)

-- Clipboard configuration ====================================================
-- Use built-in OSC 52 clipboard provider over SSH for seamless sync with local OS
...
vim.o.inccommand     = 'split'    -- Preview substitutions live in a split window
...
vim.o.scrolloff      = 8          -- Minimal lines to keep above/below cursor
